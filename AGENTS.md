...
- The canonical PLTR evidence asset is
  ...
  filing data cut is 2026-08-04, and its fixed-rule strategy snapshot is
  2026-08-13.
- Describe the PLTR case study as an August 2026 point-in-time diagnostic
  replay, never as proof that a live alert was archived or delivered in August
  2025. Preserve the full sequence: first green flag on 2025-08-06, reset to
  watch on 2025-11-05, 3.9× broad-stage peer-context breakout on 2026-02-18,
  and fixed-rule Top-20 replay entry on 2026-05-08.
