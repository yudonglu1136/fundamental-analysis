...
const CHART_URLS = {
  ANET: "https://query1.finance.yahoo.com/v8/finance/chart/ANET?range=10y&interval=1d&events=history%7Cdiv%7Csplit&includeAdjustedClose=true",
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    note: "Use npm run anet:backend:import-prices after this fetch to promote these files into daily_price_bars.",
    fetched,
    officialFilingSources: [
      "https://investors.arista.com/financials/sec-filings/default.aspx",
      "https://www.sec.gov/edgar/browse/?CIK=1596532",
    ],
  }, null, 2));
}
