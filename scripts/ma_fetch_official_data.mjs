...
const CHART_URLS = {
  MA: "https://query1.finance.yahoo.com/v8/finance/chart/MA?range=10y&interval=1d&events=history%7Cdiv%7Csplit&includeAdjustedClose=true",
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    note: "Use npm run ma:backend:import-prices after this fetch to promote these files into daily_price_bars.",
    fetched,
    officialFilingSources: [
      "https://investor.mastercard.com/financials/sec-filings/default.aspx",
      "https://www.sec.gov/edgar/browse/?CIK=1141391",
    ],
  }, null, 2));
}
