...
const CHART_URLS = {
  V: "https://query1.finance.yahoo.com/v8/finance/chart/V?range=10y&interval=1d&events=history%7Cdiv%7Csplit&includeAdjustedClose=true",
...
async function main() {
  ...
  console.log(JSON.stringify({
    ...
    note: "Use npm run v:backend:import-prices after this fetch to promote these files into daily_price_bars.",
    fetched,
