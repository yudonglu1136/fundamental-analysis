...
import type { IsrgDashboardData } from "../model";

export type IsrgComponentProps = {
  dashboard: IsrgDashboardData;
};

export function formatUsd(value: number | null | undefined, suffix = "M") {
  if (value == null || Number.isNaN(value)) return "N/A";
  return `$${value.toLocaleString("en-US", { maximumFractionDigits: Math.abs(value) >= 100 ? 0 : 1 })}${suffix}`;
}
