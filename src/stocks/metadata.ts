...
export const stockMetadataList: StockMetadata[] = [
  ...
  { ticker: "BE", name: "Bloom Energy Corporation", sector: "Power / Fuel Cells / AI Data-Center Energy Infrastructure", description: "Bloom Energy research cockpit focused on AI data-center power scarcity, solid-oxide fuel-cell deployments, backlog conversion, project economics, hydrogen optionality, cash burn, and valuation." },
  ...
  { ticker: "UNH", name: "UnitedHealth Group Incorporated", sector: "Managed Care / Healthcare Services / Optum", description: "UnitedHealth research cockpit focused on medical cost trend, Medicare Advantage repricing, Optum Health/Rx/Insight economics, PBM regulation, FCF conversion, capital return, and valuation." },
