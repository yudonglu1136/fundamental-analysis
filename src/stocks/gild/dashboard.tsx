...
import { buildBiopharmaDashboardData } from "../biopharmaResearch/engine";
import type { BiopharmaDashboardData, BiopharmaResearchDataset } from "../biopharmaResearch/types";
import { GildBacktestPanel, GildHistoricalValuationPanel } from "./GildStandardApiPanels";
...
export function GildDashboard({ module, scenario, dataSourceType }: StockDashboardProps) {
  ...
  const apiModeEnabled = import.meta.env.VITE_GILD_API_MODE === "true";
    ...
    <div className="space-y-6">
      ...
      <Tabs.Root value={tab} onValueChange={setTab}>
        ...
        <Tabs.Content value="valuation" className="mt-6 space-y-6">
          <SectionCard title="Valuation"><Valuation dashboard={dashboard} /></SectionCard>
          {apiModeEnabled ? (
            <>
              <GildBacktestPanel />
              <GildHistoricalValuationPanel scenario={scenario} />
            </>
          ) : null}
        </Tabs.Content>
