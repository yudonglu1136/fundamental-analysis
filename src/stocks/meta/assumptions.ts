...
export const metaAssumptionDefinitions: ValuationAssumption[] = [
  ...
  { key: "revenueGrowth", label: "Revenue Growth", value: defaultMetaAssumptions.revenueGrowth, min: 0.02, max: 0.25, step: 0.005, format: "percent", source: "actual", description: "Core company growth assumption for DCF and scenario work.", category: "Overview", periodicity: "annual" },
  { key: "operatingMargin", label: "Operating Margin", value: defaultMetaAssumptions.operatingMargin, min: 0.3, max: 0.5, step: 0.005, format: "percent", source: "actual", description: "Family of Apps margin after ad efficiency and AI uplift.", category: "Ads Engine", periodicity: "annual" },
  { key: "taxRate", label: "Tax Rate", value: defaultMetaAssumptions.taxRate, min: 0.1, max: 0.25, step: 0.005, format: "percent", source: "actual", description: "After-tax conversion for AI Ad ROIC and valuation math.", category: "Valuation", periodicity: "annual" },
  { key: "adRevenueGrowth", label: "Ad Revenue Growth", value: defaultMetaAssumptions.adRevenueGrowth, min: 0.02, max: 0.25, step: 0.005, format: "percent", source: "actual", description: "Growth in Family of Apps ad revenue.", category: "Ads Engine", periodicity: "annual" },
  { key: "adImpressionsGrowth", label: "Ad Impressions Growth", value: defaultMetaAssumptions.adImpressionsGrowth, min: 0.01, max: 0.2, step: 0.005, format: "percent", source: "actual", description: "Impression growth from feed and reels engagement.", category: "Ads Engine", periodicity: "annual" },
  ...
  { key: "whatsappRevenue", label: "WhatsApp Business Revenue", value: defaultMetaAssumptions.whatsappRevenue, min: 2, max: 16, step: 0.1, format: "currency", source: "actual", description: "Annual business messaging / WhatsApp revenue run rate.", category: "WhatsApp Optionality", unit: "USD", periodicity: "annual" },
  ...
  { key: "whatsappOptionalityValue", label: "WhatsApp Optionality Value", value: defaultMetaAssumptions.whatsappOptionalityValue, min: 0, max: 100, step: 1, format: "currency", source: "assumption", description: "Optionality placeholder when the business messaging monetization path is modeled directly.", category: "WhatsApp Optionality", unit: "USD" },
