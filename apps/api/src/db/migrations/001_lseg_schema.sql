...
CREATE INDEX IF NOT EXISTS idx_reporting_events_ticker_date ON reporting_events(ticker, eventDate);
CREATE INDEX IF NOT EXISTS idx_financial_periods_event ON financial_periods(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_segment_financials_event ON segment_financials(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_market_snapshots_asof ON market_snapshots(ticker, asOfDate);
CREATE INDEX IF NOT EXISTS idx_peer_snapshots_asof ON peer_snapshots(ticker, asOfDate);
CREATE INDEX IF NOT EXISTS idx_valuation_runs_lookup ON valuation_runs(ticker, asOfDate, reportingEventId, scenario, modelVersion);
CREATE INDEX IF NOT EXISTS idx_lseg_daily_price_bars_ticker_date ON daily_price_bars(ticker, priceDate);
