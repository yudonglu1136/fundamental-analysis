...
CREATE TABLE IF NOT EXISTS geographic_financials (
  id TEXT PRIMARY KEY,
  ticker TEXT NOT NULL,
  periodId TEXT NOT NULL,
  eventId TEXT,
...
CREATE TABLE IF NOT EXISTS operating_metric_snapshots (
  ...
  asOfDate TEXT NOT NULL,
  sourceType TEXT,
  installedBaseCommentary TEXT,
  activeDevicesCommentary TEXT,
  paidSubscriptionsCommentary TEXT,
  appStoreRegulationCommentary TEXT,
  chinaCommentary TEXT,
  fxImpactCommentary TEXT,
  iphoneCycleCommentary TEXT,
  aiAppleIntelligenceCommentary TEXT,
  visionProCommentary TEXT,
...
CREATE INDEX IF NOT EXISTS idx_aapl_daily_price_bars_ticker_date
...
CREATE INDEX IF NOT EXISTS idx_aapl_reporting_events_ticker_date ON reporting_events(ticker, eventDate);
CREATE INDEX IF NOT EXISTS idx_aapl_financial_periods_event ON financial_periods(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_segment_financials_event ON segment_financials(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_product_financials_event ON product_financials(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_geographic_financials_event ON geographic_financials(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_operating_metric_snapshots_asof ON operating_metric_snapshots(ticker, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_market_snapshots_asof ON market_snapshots(ticker, asOfDate);
CREATE INDEX IF NOT EXISTS idx_aapl_valuation_runs_lookup ON valuation_runs(ticker, asOfDate, reportingEventId, scenario, modelVersion);
