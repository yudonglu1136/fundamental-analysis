...
CREATE TABLE IF NOT EXISTS financial_periods (
  ...
  sourceType TEXT,
  currency TEXT,
  reportedNetSales REAL,
  organicNetSalesGrowth REAL,
  volumeGrowth REAL,
  priceMixGrowth REAL,
  fxImpact REAL,
  revenue REAL,
...
CREATE TABLE IF NOT EXISTS market_snapshots (
  ...
  currency TEXT,
  marketCap REAL,
  marketCapCurrency TEXT,
  enterpriseValue REAL,
  enterpriseValueCurrency TEXT,
  sharesOutstanding REAL,
  netDebt REAL,
  netDebtCurrency TEXT,
  previousClose REAL,
...
CREATE INDEX IF NOT EXISTS idx_dge_daily_price_bars_ticker_date
...
CREATE INDEX IF NOT EXISTS idx_dge_reporting_events_ticker_date ON reporting_events(ticker, eventDate);
CREATE INDEX IF NOT EXISTS idx_dge_financial_periods_event ON financial_periods(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_dge_segment_financials_event ON segment_financials(ticker, eventId, asOfDate);
CREATE INDEX IF NOT EXISTS idx_dge_market_snapshots_asof ON market_snapshots(ticker, asOfDate);
CREATE INDEX IF NOT EXISTS idx_dge_valuation_runs_lookup ON valuation_runs(ticker, asOfDate, reportingEventId, scenario, modelVersion);
