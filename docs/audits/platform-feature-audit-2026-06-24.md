...
| Ontology | PIT strategy and market graph | Inspect current signals, historical snapshots, industry context, and strategy evidence | `OntologyDashboard` | Production replacement is live | Needs ongoing PIT freshness and graph-coverage checks | P0 | Keep source dates visible and regression-test legacy-route redirects | Active |
